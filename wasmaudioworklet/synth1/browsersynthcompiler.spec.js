...
describe('browsersynthcompiler', function () {
    ...
    it('should compile to wasm midi multipart module', async ()=> {
        ...
        const activeVoicesStatusSnapshot = new Uint8Array(wasminstance.memory.buffer,wasminstance.activeVoicesStatusSnapshot.value,32*3);
        ...
        assert.ok(activeVoicesStatusSnapshot.findIndex((v, n, arr) =>
            v === 0 && arr[n + 1] === 1*12 && arr[n + 2] === 100) > -1);
